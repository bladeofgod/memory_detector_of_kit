...
class RawLeakNode{
  ...
  RawLeakNode(this.leakedInstance, this.maxRetainingPath);
...
class RetainingNode {
  ...
  bool important = false; //经过分析是否为重要的节点
...
class SourceCodeLocation {
  ...
  SourceCodeLocation(
      this.code, this.lineNum, this.columnNum, this.className, this.uri, this.relativeCode);
